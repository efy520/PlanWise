...
<head>
    ...
    <title>Add Transfer - PlanWise</title>
...
<div class="container-fluid px-3 px-md-4 py-4">
    ...
    <!-- TOP TABS + BACK BUTTON -->
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <a href="records.php" class="btn-back">← Back</a>

            <div class="nav-menu">
                <a href="t-income.php" class="nav-item">Income</a>
                <a href="t-expense.php" class="nav-item">Expense</a>
                <a href="t-transfer.php" class="nav-item active">Transfer</a>
            </div>

            <!-- spacer to center menu properly -->
